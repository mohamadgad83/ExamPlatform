        ...
        <CardContent className="space-y-4">
          ...
          {role === "student" ? (
            <form onSubmit={studentForm.handleSubmit(onStudentSubmit)} className="space-y-4">
              <div><label className="text-sm font-medium">الاسم الكامل</label><Input {...studentForm.register("name")} placeholder="الاسم الثلاثي" className="mt-1" /></div>
              ...
              <div><label className="text-sm font-medium">كلمة المرور</label><Input type="password" {...studentForm.register("password")} placeholder="******" className="mt-1" /></div>
              <div><label className="text-sm font-medium">تأكيد كلمة المرور</label><Input type="password" {...studentForm.register("confirmPassword")} placeholder="******" className="mt-1" /></div>
              <Button type="submit" className="w-full" disabled={studentForm.formState.isSubmitting}>
                {studentForm.formState.isSubmitting ? "جاري الإنشاء..." : "إنشاء الحساب"}
              </Button>
            </form>
          ) : (
            <form onSubmit={teacherForm.handleSubmit(onTeacherSubmit)} className="space-y-4">
              <div><label className="text-sm font-medium">الاسم الكامل</label><Input {...teacherForm.register("name")} placeholder="الاسم الثلاثي" className="mt-1" /></div>
              ...
              <div><label className="text-sm font-medium">كلمة المرور</label><Input type="password" {...teacherForm.register("password")} placeholder="******" className="mt-1" /></div>
              <div><label className="text-sm font-medium">تأكيد كلمة المرور</label><Input type="password" {...teacherForm.register("confirmPassword")} placeholder="******" className="mt-1" /></div>
              <Button type="submit" className="w-full" disabled={teacherForm.formState.isSubmitting}>
                {teacherForm.formState.isSubmitting ? "جاري الإنشاء..." : "إنشاء الحساب"}
              </Button>
            </form>
          )}
